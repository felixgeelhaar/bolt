...
Thank you for your interest in contributing to Logma! This document provides guidelines and instructions for contributing to the project.
...
3. **Add** the original repository as upstream:
   ```bash
   git remote add upstream https://github.com/felixgeelhaar/logma.git
   ```
...
By contributing to Logma, you agree that your contributions will be licensed under the [MIT License](LICENSE).

---

Thank you for contributing to Logma! 🚀